...
public class Main {
	...
	public static void main(String[] args) {
		...
		//Employee emp=new Employee(107,"Shivam",90904.90f);
		Manager m=new Manager(103,"Suman",9800.90f,1789.5f,1987.60f);
		
		Clerk c=new Clerk(104,"Souvick",19876.50f,19087.55f);
