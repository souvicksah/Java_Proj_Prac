...
<body
	style="background-image: url('https://png.pngtree.com/thumb_back/fh260/back_pic/04/01/71/7858020a3b8673e.jpg'); background-repeat: no-repeat; background-attachment: fixed; background-size: cover;">
            ...
            <label for="source">Source</label>
 			<select class="form-control" name="source" id="source">
              ...
              <label for="bookingdate">Booking Date</label>
			   <input id="datepicker" width="276" data-date-end-date="1d"/>
			    <script>
             ...
             <div class="card" style="width: 19rem;">
                ...
                <div class="card-body">
                	...
                	<h5 class="card-title"> TruckType:${product.trucktype}</h5>
               		...
               		<button value='${product.id}' id="btn_update" class="btn btn-primary">Update</button>
               		<a href="product_update_form.htm?id=${product.id}" class="btn btn-primary">Pay Now</a>
           		</div>
            </div>
         </div>
	</c:forEach>
