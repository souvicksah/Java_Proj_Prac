              					...
              					<div class="card-body p-md-5 text-black">
                					...
                					<div class="form-outline mb-4">
                						<label class="form-label" for="form3Example97">Email ID</label><label style="color: red;"><b>*</b></label>
                  						<input type="text" id="form3Example97" class="form-control form-control-lg" name="email" placeholder="Enter Email ID" required="required" style="border:1px solid black;"/>
                					</div>

                					<div class="form-outline mb-4">
                						<label class="form-label" for="form3Example90">Password</label><label style="color: red;"><b>*</b></label>
                  						<input type="password" id="form3Example90" class="form-control form-control-lg" name="password" placeholder="Enter Password" required="required" style="border:1px solid black;"/>
                					</div>
                					<div class="pt-1 mb-4">
